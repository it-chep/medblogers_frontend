...
export const MyCheckbox: FC<IProps> = ({label, checked}) => {
    ...
    return (
        <label className={classes.myCheckbox} onMouseDown={cancelSelection}>
            <input defaultChecked={checked} className={classes.checkbox} type="checkbox"/>

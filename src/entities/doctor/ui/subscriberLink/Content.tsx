...
export const Content: FC<IProps> = ({socialIconSrc, subsCount, text, fontSize}) => {

    return (
        <>
            <Image src={socialIconSrc} alt="Соцсеть" height={30} width={30} />
            <section style={{fontSize: fontSize ? (fontSize + 'px') : '16px'}} className={classes.subsText}>

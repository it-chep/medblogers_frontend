    ...
    return (
        <section className={classes.container}>
            {price.split('').map((p, ind) => 
                <span 
                    key={ind} 
                    className={classes.price + ((ind < (+priceCategory)) ? ` ${classes.highlight}` : '')}
                >
                    <svg key={ind} width="9.75" height="10.5" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">

                ...
                <main className={classes.main}>
                    <section className={blogClasses.container}>
                        <section className={blogClasses.content}>
                            ...
                            <p>Любой технологический проект проходит несколько стадий: от идеи и прототипа до полноценного продукта, который начинает формировать целую экосистему вокруг себя. Именно так мы и развиваем MEDBLOGERS BASE.</p>
                            ...
                            <ul>
                                ...
                                <li>добавили информацию об общем числе врачей и их подписчиков на <a href="https://t.me/it_necheporuk/111" target="_blank" rel="noopener noreferrer">главной странице</a>;</li>
